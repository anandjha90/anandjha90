...
Ans:   
Sigmoid: This function squashes the input into a range between 0 and 1, making it useful for output layers in binary classification tasks. However, it can suffer from the vanishing gradient problem.  
